    ...
    <nav class="navbar top-navbar navbar-expand-md">
        <div class="navbar-header" data-logobg="skin6">
            ...
            <div class="navbar-brand justify-content-start" onclick="window.location.href = '/panitia'"
                ...
                <!-- Dark Logo icon -->
                <img src="{{ asset('img/logo/himsi.png') }}" height="48" alt="homepage" class="dark-logo" />
                <!-- Light Logo icon -->
                <img src="{{ asset('img/logo/himsi.png') }}" height="48" alt="homepage" class="light-logo" />
                <!--End Logo icon -->
                <!-- Logo text -->
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                        ...
                        <span class="ml-2 d-none d-lg-inline-block"><span>Hello,</span> <span
                                class="text-dark">{{ substr(auth()->user()->full_name, 0, 12) }}</span> <i
                    ...
                    <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                        ...
                        <form action="/authentication/logout" method="POST">
                            ...
                            <button type="submit" class="dropdown-item" href="javascript:void(0)"><i
                                    data-feather="power" class="svg-icon mr-2 ml-1"></i>Logout</button>
                        </form>
                    </div>
                </li>
                <!-- ============================================================== -->
